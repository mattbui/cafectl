...
The `fixedSizeSymbol`, `inkBounds`, and `tintedImage` methods in
`Sources/cafectl/MenuBar.swift` derive from
[vorssaint-utils](https://github.com/vorssaint/vorssaint-utils), revision
